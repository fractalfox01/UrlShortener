      ...
      if(fetch == zeno){
        ...
        .then(function(resp){
          ...
          for(var i = 0; i < resp.length; i++){
            let tmp = "https://lml.glitch.me/?" + (i+1);
            res.write("<h1 style='margin-left:10vw;background-color:#cca;color:red;text-align:center;width:50px;'>" + (i+1) + ". </h1><h5 style='padding:5px 0px 5px 40px;background-color:#000;width:50vw;color:#ccf;margin-left:20vw;'>Redirects to <span style='color:#0d0;padding-left:5px;'>" + JSON.stringify(resp[i].url) + "</span></h1>");
